...
{
    public partial class SHScrappingFromNG01UC : StockUserControl
    {
        #region Properties
        ...
        public override IDto Dto
        {
            get
            {
                if (!DesignMode)
                {
                    ...
                    dto.TransactionSubCode = CommonData.TransactionSubCode.SH_ScrappingFromNG;
