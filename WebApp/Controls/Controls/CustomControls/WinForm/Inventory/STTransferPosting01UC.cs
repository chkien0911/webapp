...
{
    public partial class STTransferPosting01UC : StockUserControl
    {
        #region Properties
        ...
        public override IDto Dto
        {
            get
            {
                if (!DesignMode)
                {
                    ...
                    dto.TransactionSubCode = CommonData.TransactionSubCode.ST_TransferPosting;
                ...
                if (!DesignMode)
                {
                    if (value != null)
                    {
                        ...
                        if (this.ViewMode == CommonData.Mode.New)
                        {
                            ...
                            this.txtDocumentNo.Text = commonBl.GetDocumentNo(CommonData.TransactionSubCode.ST_TransferPosting);
