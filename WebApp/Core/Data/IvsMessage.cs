...
namespace Ivs.Core.Data
{
    public class IvsMessage
    {
        ...
        public IvsMessage(string messageId)
        {
            ...
            //Ivs.Resources.Common.I18n i18n = new Ivs.Resources.Common.I18n();

            _messageId = messageId;

            this.SplitMessage(I18n.GetMessage(messageId), ref _messageText, ref _messageIcon);
        ...
        public IvsMessage(string messageId, params object[] parameters)
        {
            try
            {
                ...
                string message = string.Format(I18n.GetMessage(messageId), parameters);
