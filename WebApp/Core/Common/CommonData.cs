...
namespace Ivs.Core.Common
{
    public static class CommonData
    {
        ...
        public struct FunctionGr
        {
            ...
            //public const string MS_Employee = "MS_Employees";
