...
namespace Ivs.Core.Common
{
    public static class CommonMethod
    {
        ...
        public static decimal? ParseNullableDecimal(object obj)
        {
            decimal? value;
            try
            {
                value = decimal.Parse(ParseString(obj));
            }
            catch
            {
                value = new Nullable<decimal>();
            }
            return value;
        }
        ...
        public static object Clone(this object origin)
        {
            ...
            object newObject = Activator.CreateInstance(origin.GetType());
            ...
            foreach (FieldInfo fi in origin.GetType().GetFields())
            {
                ...
                if (ICloneType != null)
                {
                    ...
                    ICloneable IClone = (ICloneable)fi.GetValue(origin);
                ...
                else
                {
                    ...
                    fields[i].SetValue(newObject, fi.GetValue(origin));
                }
                ...
                if (IEnumerableType != null)
                {
                    ...
                    IEnumerable IEnum = (IEnumerable)fi.GetValue(origin);
        ...
        public static T Cast<T>(this object myobj)
        {
            ...
            System.Reflection.PropertyInfo[] properties = type.GetProperties();
            object toObj = Activator.CreateInstance(typeof(T));
            ...
            foreach (System.Reflection.PropertyInfo property in properties)
            {
                ...
                {
                    propType = new NullableConverter(propType).UnderlyingType;
                    object safeValue = (property.GetValue(myobj, null) == null) ? null
                                                      : Convert.ChangeType(property.GetValue(myobj, null), propType);
                    propertyInfo.SetValue(toObj, safeValue, null);
                    continue;
                }
                //2013-11-17 end

                object value = (property.GetValue(myobj, null) == null) ? null
                                                      : Convert.ChangeType(property.GetValue(myobj, null), propType);
                propertyInfo.SetValue(toObj, value, null);
            }
        ...
        public static string ProcessDbExcetion(int returnCode)
        {
        ...
        public static string GetCssClass(this object htmlAttributes)
        {
            string classAttribute = CommonData.StringEmpty;
            if (htmlAttributes != null)
            {
                var attributes = HtmlHelper.AnonymousObjectToHtmlAttributes(htmlAttributes);
                if (attributes.ContainsKey("class"))
                {
                    classAttribute = CommonMethod.ParseString(attributes["class"]);
                    //classAttribute = FilterCssClass(attributes["class"].ToString());
                }
            }
            return classAttribute;
        }

        //public static string FilterCssClass(this string classAttribute)
        //{
        //    var result = classAttribute;
        //    result = result.Replace("width-small", "col-sm-2 col-md-2 replace");
        //    result = result.Replace("widthsmall", "col-sm-2 col-md-2 replace");
        //    result = result.Replace("small", "col-sm-2 col-md-2 replace");

        //    result = result.Replace("width-medium", "col-sm-3 col-md-3 replace");
        //    result = result.Replace("widthmedium", "col-sm-3 col-md-3 replace");
        //    result = result.Replace("medium", "col-sm-3 col-md-3 replace");

        //    result = result.Replace("width-large", "col-sm-8 col-md-8 replace");
        //    result = result.Replace("widthlarge", "col-sm-8 col-md-8 replace");
        //    result = result.Replace("large", "col-sm-8 col-md-8 replace");
